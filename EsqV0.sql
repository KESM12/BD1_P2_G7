...
ALTER TABLE HISTORIAL_AUDITORIA ADD CONSTRAINT HIST_AUDITORIA_EMPLEADOS_FK FOREIGN KEY ( EMPLEADOS_id_empleado ) REFERENCES EMPLEADOS ( id_empleado ) ;

--  ERROR: FK name length exceeds maximum allowed length(30)
ALTER TABLE HISTORIAL_AUDITORIA ADD CONSTRAINT HIST_AUDIT_TRANSACCIONES_FK FOREIGN KEY ( TRANSACCIONES_id_transaccion ) REFERENCES TRANSACCIONES ( id_transaccion ) ;
